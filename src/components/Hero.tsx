      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-9">
            <h1 className="mb-4 text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Market place & Fieldservice Management
            </h1>
            <div className="w-5/6">
            <SearchableDropdown
        options={works}
        ...
        className=" rounded-3xl h-[50px]" // Placeholder prop
      /></div>
